  ...
  <div class='container' style='margin:30px 20px 30px 20px;'>\n\
    ...
    <div class='col-md-2' id='ms_arrow'>\n\
      ...
      <div class='row' >\n\
          ...
          <div class='col-md-6'>\n\
           <form action='http://localhost/cgi-bin/MAP2.cgi' method='post' enctype='multipart/form-data' role='form' target='_parent'>\n\
      ...
      <div class='row' style='padding-top:20px'>\n\
        <div class='form-group' style='font-size:20px'>\n\
          ...
          <a href=\"#\"data-toggle=\"popover\" data-html=\"True\" data-placement=\"left\"\n\
            data-content=\"\n\
               <form class='form form-inline' action='http://localhost/cgi-bin/MAP2.cgi' method='post' enctype='multipart/form-data' role='form'>\n\
